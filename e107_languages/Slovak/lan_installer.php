...
define("LANINS_025", "MySQL užívateľ:");
...
define("LANINS_039", "Uistite sa prosím, že vyplníte všetky polia, hlavne MySQL server, MySQL užívateľ  a MySQL databáza (Tieto MySQL server požaduje vždy)");
...
define("LANINS_086", "Užívateľské meno administrátora, jeho heslo a email sú vyžadované polia. Vráťte sa na predchádzajúcu stranu a overte si, či ste zadali správne informácie.");
...
define("LANINS_123", "Voliteľné: Vaše verejné meno alebo alias. Nechajte prázdne, ak chcete použiť užívateľské meno");
