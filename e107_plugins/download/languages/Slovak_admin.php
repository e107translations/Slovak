...
define("DOWLAN_116", "Limit pre túto triedu užívateľov už existuje");
define("DOWLAN_117", "Limit úspešne pridaný");
define("DOWLAN_118", "Limit nebol pridaný - neznáma chyba");
define("DOWLAN_119", "Limit bol úspešne odstránený");
define("DOWLAN_120", "Limit nebol odstránený - neznáma chyba");
define("DOWLAN_121", "Limit bol úspešne aktualizovaný");
...
define("DOWLAN_126", "Aktualizovaný stav aktivácie");
...
define("LAN_DL_SECURITY_MODE_NONE", "Žiadny (predvolené)");
...
define("LAN_DL_SECURITY_NGINX_SECURELINKMD5_EXPRESSION_HELP", "Rovnaký spôsob ako je nakonfigurovaný na serveri");
define("LAN_DL_SECURITY_LINK_EXPIRY", "Doba platnosti v sekundách");
define("LAN_DL_SECURITY_LINK_EXPIRY_HELP", "Počet sekúnd, počas ktorých má odkaz na stiahnutie trvať po vygenerovaní. " . " Účinné len vtedy, ak výraz podporuje čas vypršania platnosti. " . "Predvolené nastavenie je veľmi dlhý čas, ak je toto pole ponechané prázdne.");
